  ...
  return (
    <div className="rounded-lg border border-slate-200 dark:border-slate-800 dark:bg-gradient-to-t dark:from-slate-800 dark:to-slate-800/30 odd:rotate-1 even:-rotate-1 p-5">
      <div className="flex items-center space-x-3 mb-2">
        ...
        <span className="text-xs text-slate-400 dark:text-slate-500">*My Hot Take</span>
      </div>
      <div className="font-aspekta font-[650] mb-1">Your Life is just a bunch of social experiments!</div>
      <p className="text-sm text-slate-500 dark:text-slate-400">All rules (legal, spiritual, religious, etc) are a framework for this experiment. You can follow these, or invent your own. </p>
    </div>
  )
}