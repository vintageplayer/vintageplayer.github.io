  ...
  return (
    <div className="rounded-lg border border-slate-200 dark:border-slate-800 dark:bg-gradient-to-t dark:from-slate-800 dark:to-slate-800/30 odd:rotate-1 even:-rotate-1 p-5">
      <div className="flex items-center space-x-3 mb-2">
        ...
        <span className="text-xs text-slate-400 dark:text-slate-500">*Cliche Quote</span>
      </div>
      <div className="font-aspekta font-[650] mb-1">Jack of all trades, master of none, though oftentimes better than a master of one!</div>
      <p className="text-sm text-slate-500 dark:text-slate-400">PS: I do have an edge in <i>Distributed Data Systems</i> and doing <i>Customer Discovery</i>.</p>
    </div>
  )
}